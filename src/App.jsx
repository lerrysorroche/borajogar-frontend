              ...
              <div className="animate-fade-in pb-12">
                ...
                <div className="mb-12 grid grid-cols-1 gap-6 md:grid-cols-3">
                  ...
                  <a
                    ...
                    className="group relative flex h-full flex-col overflow-hidden rounded-3xl border border-fuchsia-500/30 bg-gradient-to-br from-fuchsia-600/20 via-pink-600/10 to-orange-500/10 p-6 shadow-lg shadow-fuchsia-500/5 transition-all duration-300 hover:-translate-y-1 hover:border-fuchsia-500/60 hover:shadow-[0_0_25px_rgba(217,70,239,0.2)] md:p-8"
                  >
                    ...
                    <div className="relative z-10 grid grid-cols-3 items-center gap-6">
                      <div className="col-span-1 flex justify-center">
                        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-tr from-orange-500 via-pink-500 to-fuchsia-600 text-white shadow-lg shadow-pink-500/30 transition-transform duration-300 group-hover:rotate-6 group-hover:scale-110">

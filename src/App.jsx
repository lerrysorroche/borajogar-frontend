            ...
            {abaAtual === 'vitrine' && (
              <div className="animate-fade-in pb-12">
                ...
                <div className="mb-12 grid grid-cols-1 gap-6 md:grid-cols-3">
                  {/* BLOCO 1: INSTAGRAM (VERSÃO SLIM) */}
                  <a
                    href="https://instagram.com/SEU_USUARIO"
                    target="_blank"
                    rel="noopener noreferrer"
                    // 👇 AQUI: Mudei o final de p-6 md:p-8 para p-4 md:p-5
                    className="group relative flex h-full flex-col overflow-hidden rounded-3xl border border-fuchsia-500/30 bg-gradient-to-br from-fuchsia-600/20 via-pink-600/10 to-orange-500/10 p-4 shadow-lg shadow-fuchsia-500/5 transition-all duration-300 hover:-translate-y-1 hover:border-fuchsia-500/60 hover:shadow-[0_0_25px_rgba(217,70,239,0.2)] md:p-5"
                  >
                    ...
                    {/* 👇 AQUI: Mudei o gap-6 para gap-4 */}
                    <div className="relative z-10 grid grid-cols-3 items-center gap-4">
                      <div className="col-span-1 flex justify-center">
                        {/* 👇 AQUI: Mudei h-16 w-16 para h-12 w-12 */}
                        <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-tr from-orange-500 via-pink-500 to-fuchsia-600 text-white shadow-lg shadow-pink-500/30 transition-transform duration-300 group-hover:rotate-6 group-hover:scale-110">
                          {/* 👇 AQUI: Mudei o h-8 w-8 do SVG para h-6 w-6 para caber no novo quadrado */}
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative flex h-full flex-col overflow-hidden rounded-3xl border border-emerald-500/30 bg-gradient-to-br from-emerald-600/20 to-green-900/10 p-6 shadow-lg shadow-emerald-500/5 transition-all duration-300 hover:-translate-y-1 hover:border-emerald-500/60 hover:shadow-[0_0_25px_rgba(16,185,129,0.2)] md:p-8"
                  >
                    ...
                    <div className="relative z-10 grid grid-cols-3 items-center gap-6">
                      <div className="col-span-1 flex justify-center">
                        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-tr from-emerald-600 to-green-400 text-white shadow-lg shadow-emerald-500/30 transition-transform duration-300 group-hover:-rotate-6 group-hover:scale-110">
                      ...
                      <div className="col-span-2 flex flex-col">
                        <h3 className="mb-1 text-sm font-black uppercase tracking-tight text-white md:text-base">
                          Fale com a Gente
                        </h3>
                  ...
                  {/* BLOCO 3: CLUBE DE VANTAGENS (STARTUP MINDSET) */}
                  <div
                    onClick={() => {
                      setAbaAtual('login');
                      setModoLogin(false);
                    ...
                    className="group relative flex h-full cursor-pointer flex-col overflow-hidden rounded-3xl border border-blue-500/30 bg-gradient-to-br from-blue-600/20 to-purple-900/10 p-6 shadow-lg shadow-blue-500/5 transition-all duration-300 hover:-translate-y-1 hover:border-blue-500/60 hover:shadow-[0_0_25px_rgba(59,130,246,0.2)] md:p-8"
                  >
                    ...
                    <div className="relative z-10 grid grid-cols-3 items-center gap-6">
                      <div className="col-span-1 flex justify-center">
                        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-tr from-blue-600 to-cyan-400 text-2xl shadow-lg shadow-blue-500/30 transition-transform duration-300 group-hover:rotate-6 group-hover:scale-110">
                          🎁
                        </div>
                      </div>
                      <div className="col-span-2 flex flex-col">
                        ...
                        <p className="text-xs font-medium leading-relaxed text-zinc-400">
                          ...
                          <strong className="text-cyan-400">10% de Cashback</strong> em jogos na
                          hora!
                        </p>
                      </div>
                    </div>

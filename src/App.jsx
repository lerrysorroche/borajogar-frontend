...
const SECOES_DASHBOARD = [
  ...
  },
  {
    ...
    icone: '💰',
    nome: 'Carteira',
    ativo: 'bg-cyan-600 text-white shadow-md shadow-cyan-600/20',
  },
  {
    id: 'seguranca',
    icone: '🔐',
...
function App() {
  ...
  // Seção visível de "Meus Acessos" (ver SECOES_DASHBOARD no topo do arquivo)
  const [secaoDashboard, setSecaoDashboard] = useState('jogos');
  ...
  const abrirConfirmacao = (jogo) => {
    ...
    // [INFO] Lógica de Desativação de Vagas (Preço = 0)
    const temPrimariaAtiva = jogo.preco_aluguel > 0;
    const temSecundariaAtiva = jogo.preco_secundaria > 0;
    ...
    if (!isEmBreve) {
      if (temPrimariaAtiva && jogo.estoque_primaria > 0) {
        slotPadrao = 'PRIMARIA';
    ...
    setModalConfirmacao({
      ...
      isEmBreve: isEmBreve,
      temPrimariaAtiva: temPrimariaAtiva,
      temSecundariaAtiva: temSecundariaAtiva,
    });
  };
        ...
        <div className="animate-fade-in fixed inset-0 z-[200] flex items-center justify-center bg-black/80 p-4 backdrop-blur-sm">
          <div className="custom-scrollbar max-h-[90vh] w-full max-w-md overflow-y-auto rounded-3xl border border-zinc-700 bg-zinc-900 p-6 shadow-2xl md:p-8">
            ...
            <div className="mb-6 space-y-3">
              {/* [INFO] UX TOP-DOWN RESTAURADO: Se a Primária está livre e NÃO for lançamento, isola ela e oculta a fila */}
              ...
              modalConfirmacao.jogo.estoque_primaria > 0 ? (
                ...
                <>
                  {/* Se a primária não tem estoque (ou está desativada), mostramos as opções restantes: */}

                  {/* UX: Mostra a Secundária se estiver ativa, tiver estoque E NÃO for lançamento */}
                  {modalConfirmacao.temSecundariaAtiva &&
                    !modalConfirmacao.isEmBreve &&
                    modalConfirmacao.jogo.estoque_secundaria > 0 && (
                      ...
                      >
                        ...
                        <p className="mt-2 pl-7 text-xs leading-relaxed text-zinc-400">
                          <strong className="text-fuchsia-400">Atenção:</strong> Na conta
                          secundária, você joga na conta da locadora e precisa estar sempre
                  ...
                  {/* Feedback visual se tudo estiver inativo (Segurança extra) */}
                  {!modalConfirmacao.temPrimariaAtiva && !modalConfirmacao.temSecundariaAtiva && (
                    <div className="rounded-2xl border border-rose-500/50 bg-rose-950/40 p-4 text-center">
                      <p className="text-xs font-bold text-rose-400">
                        Nenhuma vaga disponível para este jogo no momento.
                      </p>
                    </div>
                  )}
                </>
          ...
          <main className="mx-auto max-w-7xl px-4 pb-12 pt-24 md:px-8 md:pt-28">
              ...
              <div className="animate-fade-in pb-12">
                ...
                <div className="mb-12 grid grid-cols-1 gap-6 md:grid-cols-3">
                  <div
                    ...
                    className="group relative flex h-full cursor-pointer flex-col justify-center overflow-hidden rounded-3xl border border-amber-500/30 bg-gradient-to-br from-amber-600/20 to-orange-900/10 p-4 shadow-lg shadow-amber-500/5 transition-all duration-300 hover:-translate-y-1 hover:border-amber-500/60 hover:shadow-[0_0_25px_rgba(245,158,11,0.2)] md:p-5"
                  >
                    <div className="absolute -right-10 -top-10 h-32 w-32 rounded-full bg-amber-500 opacity-20 blur-3xl transition-transform duration-500 group-hover:scale-150"></div>
                    <div className="relative z-10 flex items-center gap-5">
                      <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-tr from-amber-500 to-yellow-300 text-2xl shadow-lg shadow-amber-500/30 transition-transform duration-300 group-hover:rotate-6 group-hover:scale-110">
                        🏆
                      </div>
                      <div className="flex flex-1 flex-col">
                        ...
                        <p className="text-[11px] font-medium leading-relaxed text-zinc-400">
                          Quanto mais você aluga, mais seu Rank sobe e maior fica seu desconto no
                          site.
                        </p>
                      </div>
                    </div>
                  ...
                  <div
                    ...
                    className="group relative flex h-full cursor-pointer flex-col justify-center overflow-hidden rounded-3xl border border-emerald-500/30 bg-gradient-to-br from-emerald-600/20 to-green-900/10 p-4 shadow-lg shadow-emerald-500/5 transition-all duration-300 hover:-translate-y-1 hover:border-emerald-500/60 hover:shadow-[0_0_25px_rgba(16,185,129,0.2)] md:p-5"
                  >
                    ...
                    <div className="relative z-10 flex items-center gap-5">
                      <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-tr from-emerald-600 to-green-400 text-2xl shadow-lg shadow-emerald-500/30 transition-transform duration-300 group-hover:-rotate-6 group-hover:scale-110">
                        ♻️
                      </div>
                      <div className="flex flex-1 flex-col">
                        <h3 className="mb-0.5 text-sm font-black uppercase tracking-tight text-white md:text-base">
                        ...
                        <p className="text-[11px] font-medium leading-relaxed text-zinc-400">
                          Devolva antes do prazo acabar e ganhe Cashback na hora. Devolveu, ganhou!
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div
                    ...
                    className="group relative flex h-full cursor-pointer flex-col justify-center overflow-hidden rounded-3xl border border-blue-500/30 bg-gradient-to-br from-blue-600/20 to-cyan-900/10 p-4 shadow-lg shadow-blue-500/5 transition-all duration-300 hover:-translate-y-1 hover:border-blue-500/60 hover:shadow-[0_0_25px_rgba(59,130,246,0.2)] md:p-5"
                  >
                    ...
                    <div className="relative z-10 flex items-center gap-5">
                      ...
                      <div className="flex flex-1 flex-col">
                        ...
                        <p className="text-[11px] font-medium leading-relaxed text-zinc-400">
                          24h no ar, sem parar. Pagou, já recebe os dados de acesso na mesma hora.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                  {jogosDaPagina.map((jogo) => {
                    ...
                    // [INFO] Lógica de Vagas Desativadas
                    const temPrimariaAtiva = jogo.preco_aluguel > 0;
                    const temSecundariaAtiva = jogo.preco_secundaria > 0;

                    // Tem estoque somente se a vaga estiver ativa (preço > 0) E tiver quantidade
                    const temEstoque =
                      (temPrimariaAtiva && jogo.estoque_primaria > 0) ||
                      (temSecundariaAtiva && jogo.estoque_secundaria > 0);

                    // Descobre qual preço mostrar no botão principal
                    const precoExibicao = temPrimariaAtiva
                      ? jogo.preco_aluguel
                      : jogo.preco_secundaria;
              ...
              <div className="animate-fade-in mx-auto max-w-6xl space-y-8">
                ...
                <div className="flex flex-col gap-6 lg:flex-row lg:items-start">
                  ...
                  <nav className="lg:w-52 lg:shrink-0">
                    <div className="grid grid-cols-2 gap-2 rounded-2xl border border-zinc-800/80 bg-zinc-950 p-2 shadow-inner sm:grid-cols-4 lg:sticky lg:top-6 lg:flex lg:flex-col">
                      {SECOES_DASHBOARD.map((s) => {
                        const ativa = secaoDashboard === s.id;
                        return (
                          <button
                            key={s.id}
                            onClick={() => {
                              setSecaoDashboard(s.id);
                              window.scrollTo(0, 0);
                            }}
                  ...
                  <div className="min-w-0 flex-1 space-y-8">
                    {secaoDashboard === 'jogos' && (
                      <div className="animate-fade-in flex flex-col gap-8">
                        <div className="group overflow-hidden rounded-3xl border border-l-4 border-emerald-500/30 border-l-emerald-500 bg-gradient-to-r from-emerald-900/20 to-zinc-900 shadow-2xl shadow-emerald-500/10">
                              ...
                              <div className="mb-8 flex items-start gap-4 rounded-2xl border border-rose-500/50 bg-rose-950/40 p-5 shadow-inner">
                                ...
                                <div>
                                  ...
                                  <p className="text-xs font-medium leading-relaxed text-zinc-300">
                                    É <strong>obrigatório</strong> desativar o "Compartilhamento de
                                    Console" ou "PS4 Principal" na sua conta ANTES do tempo de
                                    aluguel expirar. O descumprimento gera uma multa automática e
                                    deixa seu saldo negativo.
                                  </p>
                                </div>
                              </div>
                            )}
                                    ...
                                    <details className="group/tut mt-6 overflow-hidden rounded-2xl border border-zinc-700/50 bg-zinc-900/50 transition-all duration-300 hover:border-zinc-600 [&_summary::-webkit-details-marker]:hidden">
                                      ...
                                      <div className="space-y-5 border-t border-zinc-700/50 bg-black/40 p-5 text-xs text-zinc-300 md:p-8">
                                        <p className="mb-4 flex items-center gap-3 border-b border-rose-500/30 pb-4 text-sm font-black uppercase tracking-wider text-rose-400">
                                          <span className="animate-pulse text-xl">⚠️</span> ATENÇÃO:
                                          NUNCA ENTRE COMO CONVIDADO!
                                        </p>
                                        <ol className="list-decimal space-y-4 pl-6 font-medium leading-relaxed">
                                          ...
                                          <li>
                                            ...
                                            <ul className="ml-1 mt-3 list-disc space-y-3 border-l-2 border-zinc-700 pl-5 text-zinc-400">
                                              <li>
                                                ...
                                                Usuários e contas &gt; Outros &gt; Compartilhamento
                                                do console... &gt;{' '}
                                              ...
                                              <li className="mt-3 flex items-center gap-3 rounded-xl border border-rose-500/20 bg-rose-950/30 p-3.5 font-bold text-rose-400">
                                                ...
                                                que no final do seu aluguel, você vai DESABILITAR o
                                                compartilhamento.
                                              </li>
                                            </ul>
                                          </li>
                                          <li className="mt-6 rounded-xl border border-emerald-500/40 bg-emerald-950/40 p-5 text-sm font-black text-emerald-400 shadow-inner">
                                            ...
                                            volte para o seu perfil pessoal (a sua conta oficial) e
                                            divirta-se!
                                          </li>
                                        </ol>
                                      </div>
                        ...
                        {historicoAlugueis.length > 0 && (
                          <div className="group overflow-hidden rounded-3xl border border-l-4 border-zinc-800 border-l-blue-500 bg-zinc-900/80 shadow-2xl shadow-blue-500/10">
                            <div className="flex items-center justify-between p-6 md:p-8">
                    ...
                    {secaoDashboard === 'fila' && (
                      <div className="animate-fade-in flex flex-col gap-8">
                        <div className="group overflow-hidden rounded-3xl border border-l-4 border-zinc-800 border-l-amber-500 bg-zinc-900/80 shadow-2xl shadow-amber-500/10">
                          <div className="flex items-center justify-between p-6 md:p-8">
                    ...
                    {secaoDashboard === 'carteira' && (
                      <div className="animate-fade-in flex flex-col gap-8">
                            ...
                            <div className="relative z-10 mt-auto flex flex-col gap-3">
                              ...
                              <div className="mt-3 flex flex-col items-center gap-1 border-t border-zinc-800/50 pt-3 opacity-80">
                                ...
                                <div className="flex items-center gap-1 text-center text-[9px] font-medium text-zinc-500">
                                  Infraestrutura de alta disponibilidade gerida por Stripe & Efí
                                  S.A.
                                </div>
                              </div>
                            </div>
                        ...
                        {usuarioLogado && usuarioLogado.codigo_indicacao && (
                          <div className="group overflow-hidden rounded-3xl border border-purple-500/30 bg-gradient-to-r from-purple-900/30 to-blue-900/20 shadow-2xl shadow-purple-500/10">
                            <div className="flex items-center justify-between p-6 md:p-8">
                            ...
                            <div className="animate-fade-in relative z-10 border-t border-purple-500/20 px-6 pb-6 pt-8 md:px-8 md:pb-8">
                              <p className="mb-8 max-w-3xl text-xs leading-relaxed text-zinc-300">
                                Mande o seu código para um amigo. Quando ele criar uma conta nova e
                                fizer a{' '}
                                <strong className="text-emerald-400">primeira recarga</strong>, nós
                                daremos <strong>10% do valor</strong> da recarga dele de presente
                                para você gastar em jogos!
                              </p>
                    ...
                    {secaoDashboard === 'seguranca' && (
                      <div className="animate-fade-in flex flex-col gap-8">
                        <div className="group overflow-hidden rounded-3xl border border-rose-500/30 bg-gradient-to-r from-rose-900/20 to-zinc-900 shadow-2xl shadow-rose-500/10">
                          <div className="flex items-center justify-between p-6 md:p-8">
                          ...
                          <div className="animate-fade-in relative z-10 border-t border-rose-500/20 px-6 pb-6 pt-8 md:px-8 md:pb-8">
                            <p className="mb-8 max-w-2xl text-xs leading-relaxed text-zinc-400">
                              Mantenha sua conta segura alterando sua senha regularmente ou troque a
                              senha temporária que enviamos por e-mail.
                            </p>
                            <form
                      ...
                      <div className="animate-fade-in flex flex-col gap-8">
                        ...
                        <div className="overflow-hidden rounded-3xl border border-l-4 border-fuchsia-500/30 border-l-fuchsia-500 bg-gradient-to-r from-fuchsia-900/20 to-zinc-900 shadow-2xl shadow-fuchsia-500/10">
                          ...
                          <div className="border-t border-fuchsia-500/20 px-6 pb-6 pt-8 md:px-8 md:pb-8">
                            ...
                            {/* 2. GESTÃO DAS OPÇÕES DA ENQUETE (mesmo padrão da área de Banners: preview em grade acima, formulário abaixo) */}
                            <div className="mt-8 border-t border-zinc-800/50 pt-6">
                              <div className="mb-4 flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-center">
                                <div>
                                  ...
                                  <p className="mt-1 text-xs font-medium text-zinc-400">
                                    Prévia de como as opções aparecem para os clientes votarem.
                                  </p>
                                </div>
                                {enqueteOpcoes.length > 0 && (
                                  <button
                                    ...
                                    type="button"
                                    className="whitespace-nowrap rounded-lg border border-rose-500/30 bg-rose-900/30 px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider text-rose-400 transition-colors hover:bg-rose-600 hover:text-white"
                                  >
                                    Limpar Enquete
                                  </button>
                                )}
                              ...
                              {/* [INFO] PREVIEW EM TEMPO REAL DAS OPÇÕES, igual ao preview dos Banners */}
                              {enqueteOpcoes.length > 0 ? (
                                <div className="mb-6 grid w-full grid-cols-3 gap-3 rounded-2xl border border-zinc-800/50 bg-black/20 p-4 shadow-inner sm:grid-cols-4 lg:grid-cols-5">
                                  {enqueteOpcoes.map((op, index) => (
                                    <div
                                      key={op.id}
                                      className="relative flex flex-col transition-transform hover:scale-105"
                                    >
                                      <div className="relative aspect-video w-full overflow-hidden rounded-xl border border-zinc-700 bg-zinc-900 shadow-md">
                                        ...
                                        />
                                        {/* Badge mostrando a ordem da opção */}
                                        <div className="absolute left-2 top-2 flex h-5 w-5 items-center justify-center rounded-md border border-fuchsia-500/30 bg-black/80 text-[10px] font-black text-fuchsia-400 backdrop-blur-md">
                                          {index + 1}
                                        </div>
                                        <button
                                          onClick={() => removerOpcaoEnquete(op.id)}
                                          title="Remover"
                                          className="absolute right-2 top-2 flex h-5 w-5 items-center justify-center rounded-md border border-rose-500/30 bg-black/80 text-rose-400 backdrop-blur-md transition-colors hover:bg-rose-600 hover:text-white"
                                        >
                                          🗑️
                                        </button>
                                        <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent p-2 pt-4">
                                          ...
                                          <p className="text-[9px] font-black text-fuchsia-400">
            ...
            <div className="fixed bottom-6 right-6 z-50 flex flex-col items-center gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center justify-center rounded-full bg-gradient-to-tr from-orange-500 via-pink-500 to-fuchsia-600 p-4 text-white shadow-xl shadow-fuchsia-500/30 transition-all duration-300 hover:-translate-y-1"
              ...
              {usuarioLogado && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-center justify-center rounded-full bg-emerald-500 p-4 text-white shadow-xl shadow-emerald-500/30 transition-all duration-300 hover:-translate-y-1 hover:bg-emerald-400"
